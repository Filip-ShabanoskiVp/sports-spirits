        ...
        .then(data=> {
            ...
            data.response.forEach(item => {
                ...
                if(item.fixture.status.short=="NS") {
                    newCell5.innerHTML = '<a href="' + "/Football/fixture/" + item.fixture.id + '/details" style="text-decoration: none;color: red">'
                ...
                if(item.fixture.status.short=="1H" || item.fixture.status.short=="2H" || item.fixture.status.short=="HT" || item.fixture.status.short=="ET"
